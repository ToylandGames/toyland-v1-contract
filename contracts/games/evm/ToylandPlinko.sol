...
contract ToylandPlinko is ToylandGames {
    ...
    function fulfillRandomWords(uint256 _requestId, uint256[] calldata _randomWords) internal override {
        ...
        uint256 rewardMultiplier = (int256(payout) - int256(game.wager * game.numBets)) > 0 ? 2074 : 100000; // win: 2.074%, lose: 100%
        uint256 rewardAmount = _payoutReward(
            playerAddress,
            game.tokenAddress,
            game.wager * game.numBets,
            rewardMultiplier
        );
